...
// });
    ...
    <div class="navbar-wrapper">
      ...
      <div class="container">
    	  ...
    	  <div class="navbar navbar-inverse">
    	   <div class="navbar-inner">
            ...
            <a class="label" href="#">
              <?php
              echo "You are signed in as $uname";
              ?>
             </a>
            ...
            <tr>
                <td>
                  <ul class="thumbnails">
                      ...
                      <div class="thumbnail">
                      <img data-src="holder.js/300x200" alt="300x200" style="width: 300px; height= 200px;" src="images/members/agnes karonji.jpg">
                      <h4>Agnes Muthoni</h4>
                      <p>Beautiful Lady</p>
                      </div>
                      </li>
      ...
      <div class="stream">
          ...
          <video controls><source src="images/videos/Facebook.mp4"></video>
